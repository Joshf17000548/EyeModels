function [eyePoints, pointLabels, targetIntersectError, rayPath, error] = refractEyePoints(eyePoints,pointLabels,sceneGeometry,p,eyePose)
...
if refractFlag
    ...
    rayPath = cell(1,length(refractPointsIdx));
    ...
    for ii=1:length(refractPointsIdx)
        ...
        [virtualImageRay, ~, intersectError, rayPath{ii}] = ...
