function [outputRay, initialRay, targetIntersectError, rayPath] = findPupilRay( eyeCoordOrigin, eyePose, worldTarget, rotationCenters, opticalSystemRot, opticalSystemFix )
...
[outputRay, rayPath] = twoSystemTrace(initialRay, eyePose, rotationCenters, opticalSystemRot, opticalSystemFix, Rstruc);
...
function [outputRayEyeCoord, rayPath] = twoSystemTrace(inputRayEyeCoord, eyePose, rotationCenters, opticalSystemRot, opticalSystemFix, Rstruc)
...
[outputRayEyeCoord, rayPath] = rayTraceQuadrics(outputRayEyeCoord', opticalSystemFix);
