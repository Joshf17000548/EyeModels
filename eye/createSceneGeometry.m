...
p.addParameter('intrinsicCameraMatrixmm',[2600 0 320; 0 2600 240; 0 0 1],@isnumeric);
...
p.addParameter('cameraRotation',[0; 0; 0] ,@isnumeric);
p.addParameter('screenPosition',[0 0 600],@isnumeric);
...
p.addParameter('targets',[], @(x)(isempty(x) | isnumeric(x)));
...
sceneGeometry.cameraIntrinsic.matrixmm = p.Results.intrinsicCameraMatrixmm;
...
%% screenPosition
sceneGeometry.screenPosition.screenPosition = p.Results.screenPosition;
...
sceneGeometry.targets = p.Results.targets;
